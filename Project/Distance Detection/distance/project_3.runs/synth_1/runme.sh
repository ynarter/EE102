...
HD_PWD='C:/Users/yigit/Desktop/project_3/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sistema_maxsonar.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sistema_maxsonar.tcl
