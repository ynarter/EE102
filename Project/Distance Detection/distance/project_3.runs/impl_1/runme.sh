...
HD_PWD='C:/Users/yigit/Desktop/project_3/project_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sistema_maxsonar.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sistema_maxsonar.tcl -notrace
